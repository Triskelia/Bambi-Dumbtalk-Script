...
; Bambi Mode : Forces you to refer yourself as Bambi (ie. "I" => "Bambi", "My" => "Bambi's"...)
...
; Verbs replacement : Replaces some specifics verbs with more fitting synonyms. ("Bambi laughs" => "Bambi giggles")
